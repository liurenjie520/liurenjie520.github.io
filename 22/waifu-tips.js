...
$('.waifu-tool .fui-info-circle').click(function (){
    window.open('http://space.bilibili.com/32890488/#/');
});
...
function initModel(waifuPath){
	...
	$.ajax({
        cache: true,
        url: 'http://static1-1251738903.file.myqcloud.com/live2d/assets/waifu-tips.json',
        dataType: "json",
...
function loadModel(modelId, modelTexturesId){
    ...
    loadlive2d('live2d', 'http://static1-1251738903.file.myqcloud.com/live2d/assets/22.json', console.log('live2d','模型 '+modelId+'-'+modelTexturesId+' 加载完成'));
}
...
function loadRandModel(){
    ...
    $.ajax({
        cache: false,
        url: '/live2d/assets/22.jso?/live2d/'+modelTexturesRandMode+'_textures/?id='+modelId+'-'+modelTexturesId,
        dataType: "json",
        success: function (result){
...
function loadOtherModel(){
    ...
    $.ajax({
        cache: false,
        url: '/live2d/assets/22.jso?/live2d/'+modelTexturesRandMode+'/?id='+modelId,
        dataType: "json",
        success: function (result){
